...
import type { InjectShuffleOptions, Lane, State } from "./shared"
import { Role, StatusCode } from "./shared"

export function doMoveCombat(state: State, lane: Lane, options?: LaxPartial<InjectShuffleOptions>): (
	{ status: StatusCode.Ok | StatusCode.DefenderWin | StatusCode.AttackerWin } & CombatData
) | {
	status: StatusCode.MadeMoveOnFinishedGame | StatusCode.DefenderInitiatedCombat |
